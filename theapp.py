...
# 
# # Page 1 includes the price prediction model that predicts prices for the user.
# def page1():
#     st.title("Prediction of House Prices")
#     # Add content for Price Prediction page
# 
...
# 
#     st.markdown('**Objective** : Given details about the house we will predict the house price. Please fill out the information then scroll down and click on the button to predict the price.')
# 
...
# 
#         # Perform prediction using model_house.py
#         predicted_price = predict(arr)
# 
#         # Display the predicted price
#         predicted_price = max(predicted_price, 0)
#         st.write(f"<span style='font-size: 30px; color: red;'>The predicted price is $ {predicted_price:.2f}</span>", unsafe_allow_html=True)
# 
# # Data for correlation chart
# # Function for Visuals
# def page2():
#     st.title("Visuals")
#     # Content for the visuals
#     st.markdown("Correlation Chart: Selected Variables vs. Sale Price")
#     # User to select variables for correlation
#     selected_vars = st.multiselect('Select variables', df_train.columns)
#     # Calculate the correlation matrix for the heat map
...
#     st.pyplot(fig)
# 
#     #box plot chart for neighborhood and sale price comparison
#     fig, ax = plt.subplots()
...
#     st.pyplot(fig)
# 
#     # Graph to see how bathrooms and bedrooms are related, user can select the number for each
#     # User input
...
# 
# 
# # This function makes the radio buttons in the sidebar for the user to navigate between the pages
# def main():
...
#       st.write("Please select a page from the sidebar to explore the different functionalities. You can use the Price Prediction page to input values and predict the house price, or use the Visuals page to see the charts and how the variables are related to each other to help you make better decisions.")
